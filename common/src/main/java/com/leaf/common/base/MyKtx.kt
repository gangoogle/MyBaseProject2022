...
import com.leaf.common.ext.lifecycle.KtxAppLifeObserver
import com.leaf.common.ext.lifecycle.KtxLifeCycleCallBack
import com.leaf.common.network.manager.NetworkStateReceive
...
val appContext: Application by lazy { MyKtx.app }

class MyKtx : ContentProvider() {
