...
public class WaveSideBar extends View {
    ...
    private boolean mOnlyFirstWords = false;
    ...
    public WaveSideBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = typedArray.getColor(R.styleable.WaveSideBar_sidebar_text_color, Color.parseColor("#377dfd"));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (String indexItem : mIndexItems) {
            ...
            if (mOnlyFirstWords) {
                text = getFirstWords(text);
            }
            mBarWidth = Math.max(mBarWidth, mPaint.measureText(text));
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0, mIndexItemsLength = mIndexItems.length; i < mIndexItemsLength; i++) {
            ...
            String text = mIndexItems[i];
            if (mOnlyFirstWords && mCurrentIndex != i) {
                text = getFirstWords(text);
            }
            // draw
            canvas.drawText(
                    text, //item text to draw
    ...
    public String getFirstWords(String text) {
        String words = "";
    ...
    public void setOnlyFirstWords(boolean onlyFirstWords) {
        this.mOnlyFirstWords = onlyFirstWords;
    }
