...
import com.rms.supply.api.ext.resColor
...
object SettingUtil {
    ...
    fun getPrimaryColor(): Int {
        return resColor(com.leaf.common.R.color.colorPrimary)
    }
    ...
    fun getBottomNavColorState(color: Int): ColorStateList {
        val colors = intArrayOf(color, ContextCompat.getColor(Utils.getApp(), com.leaf.common.R.color.colorGray999))
    ...
    fun getOneColorStateList(context: Context): ColorStateList {
        val colors = intArrayOf(getPrimaryColor())
